...
function Study(){
    ...
    const [questions, setQuestions] = useState([["Une question?", "Username", "05-02-2024", "Ferme"], ["Deux question?", "Username2", "03-02-2024", "Ouvert"]])
    ...
    useEffect(() => {
        if(nav){
            navigate("/forum", { state: passQuestion});
        }
    })
        ...
        <div className='background-study'>
            ...
            <div className='question-part'>
                ...
                {questions.map(question => 
                    <li key={question[0]}>
                        <span onClick={() => {setNav(true); setPassQuestion(question[0])}}>{question[0]}</span>
